...
from Networks.multi_layer_net_extend import MultiLayerNetExtend
from Layers.optimizer import SGD, Adam
...
def __train(weight_init_std):
    ...
    for i in range(1000000000):
        ...
        grads1 = bn_network.gradient(x_batch, t_batch)
        optimizer1.update(bn_network.params, grads1)
        grads2 = network.gradient(x_batch, t_batch)
        optimizer2.update(network.params, grads2)
